...
namespace BookWeb.Controllers
{
    public class CategoryV2Controller : Controller
    {
        ...
        public CategoryV2Controller(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: CategoryV2/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CategoryV2/Create
